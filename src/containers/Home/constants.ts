...
export const HELPER_NOTES: Array<string> = [
  message.help.note1,
  message.help.note2,
];
export const HELPER_CONTENT: Array<Content> = [
  {
    title: message.help.contentTitle,
    body: [
      message.help.content1,
      message.help.content2,
      message.help.content3,
      message.help.content4,
      message.help.content5,
    ],
  },
];
